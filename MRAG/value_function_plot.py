...
from utilities import check1v2, check1v1
...
jointstates1v1_D1 = (ax, ay, d1x, d1y)
jointstates1v1_D2 = (ax, ay, d2x, d2y)
ax_slice_1v1_1, ay_slice_1v1_1, d1x_slice_1v1_1, d1y_slice_1v1_1 = lo2slice1v1(jointstates1v1_D1, slices=grid_size1v1)
ax_slice_1v1_2, ay_slice_1v1_2, d2x_slice_1v1_2, d2y_slice_1v1_2 = lo2slice1v1(jointstates1v1_D2, slices=grid_size1v1)
...
value = value1v2[ax_slice, ay_slice, d1x_slice, d1y_slice, d2x_slice, d2y_slice]
...
print(f"************ The initial capture result of the 1 vs. 2 game is {check1v2(value1v2, jointstates2v1, grid_size=grid_size1v2)}. ************ \n")
print(f"************ The initial capture result (D1) of the 1 vs. 1 game is {check1v1(value1v1, jointstates1v1_D1, grid_size=grid_size1v1)}. ************ \n")
print(f"************ The initial capture result (D2) of the 1 vs. 1 game is {check1v1(value1v1, jointstates1v1_D2, grid_size=grid_size1v1)}. ************ \n")
