...
print(f"================ The shape of the value1vs0_dub is {value1vs0_dub.shape}. ================")
num_attackers = 1
num_defenders = 1
initial_attacker = np.array([[-0.5, 0.0, -math.pi/2]])
...
print(f"The initial value of the initial states is {check_current_value_dub(game.attackers.state, game.defenders.state, value1vs0_dub[..., -1])}")
