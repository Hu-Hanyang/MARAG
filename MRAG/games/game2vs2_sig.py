...
from MRAG.sig_controllers import hj_controller_attackers, hj_controller_defenders, extend_hj_controller_defenders
...
num_attackers = 2
num_defenders = 2
initial_attacker = np.array([[-0.5, 0.5], [0.8, -0.5]])   # np.array([[-0.8, -0.5], [-0.8, 0.5]])
initial_defender = np.array([[-0.3, 0.0], [0.3, 0.0]]) #np.array([[0.8, 0.0]])
